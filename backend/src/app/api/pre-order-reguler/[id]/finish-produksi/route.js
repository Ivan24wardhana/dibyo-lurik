// =====================================================
// /api/pre-order-reguler/[id]/finish-produksi
// POST - tandai PO selesai produksi (sedang_diproses → selesai)
...
export const POST = withAuthAndRole(PRE_ORDER_UPDATE_ROLES, async ({ params }) => {
  ...
  return successResponse(result.data, 'Pre-order selesai diproses')
})